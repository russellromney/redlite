			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'JSON', slug: 'commands/json' },
						{ label: 'RediSearch', slug: 'commands/redisearch' },
						{ label: 'Transactions', slug: 'commands/transactions' },
						{ label: 'Pub/Sub', slug: 'commands/pubsub', badge: { text: 'Server Only', variant: 'note' } },
						{ label: 'Blocking Ops', slug: 'commands/blocking' },
						{ label: 'Server & Connection', slug: 'commands/server' },
						{ label: 'Client Commands', slug: 'commands/clients' },
						{ label: 'Memory', slug: 'commands/memory' },
